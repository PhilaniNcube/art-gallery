...
const GallerySection = () => {
  return <section>
    <div className="max-w-6xl mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-5 grid-rows-2 mt-6 gap-6">
        <Image src="/images/desktop/image-grid-2@2x.jpg" alt="Gallery" className="col-span-3 row-span-2" width={1270} height={1440} />
        <Image src="/images/desktop/image-grid-3@2x.jpg" alt="Gallery" className="col-span-2 h-full w-full object-cover row-span-1" width={890} height={626} />
        <div className="bg-dark flex flex-col p-8 col-start-4 col-span-2 row-start-2 h-full w-full">
